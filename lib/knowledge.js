...
export const schoolInfo = {
  ...
  plataformas: {
    principal: {
      nombre: "[Nombre de la plataforma - ej: Idukay]",
  ...
  faq: [
    ...
    },
    {
      ...
      respuesta:
        "Después de las 07:10 se registra atraso. Tres atrasos injustificados equivalen a una falta leve. Debes pasar por inspección para obtener permiso de ingreso.",
    },
    {
